  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event_type as @event_type" do
        ...
        post :create, {:event_type => { "name" => "invalid value" }}, valid_session
        assigns(:event_type).should be_a_new(EventType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event_type" do
        ...
        EventType.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => event_type.to_param, :event_type => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the event_type as @event_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        EventType.any_instance.stub(:save).and_return(false)
        put :update, {:id => event_type.to_param, :event_type => { "name" => "invalid value" }}, valid_session
        assigns(:event_type).should eq(event_type)
      end
